...
INSERT INTO agent_task (agent_config_id, task_id, type, enabled, generation, schedule_interval_seconds, schedule_jitter_percent, schedule_enabled, params)
VALUES ('da36794e-83a3-4e2c-b799-b7b4e7b68768', 'trace-to-sa', 'trace', true, 1, 40, 10, true, '{"target": "10.0.0.6", "method": "icmp-paris"}')
ON CONFLICT DO NOTHING;
...
INSERT INTO agent_task (agent_config_id, task_id, type, enabled, generation, schedule_interval_seconds, schedule_jitter_percent, schedule_enabled, params)
VALUES ('fff05400-686d-46fe-b6d7-a660569f5228', 'ping-to-cloudflare', 'ping', true, 1, 20, 10, true, '{"target": "1.1.1.1", "count": 5, "size": 64}')
ON CONFLICT DO NOTHING;

INSERT INTO agent_task (agent_config_id, task_id, type, enabled, generation, schedule_interval_seconds, schedule_jitter_percent, schedule_enabled, params)
VALUES ('fff05400-686d-46fe-b6d7-a660569f5228', 'trace-to-cloudflare', 'trace', true, 1, 40, 10, true, '{"target": "1.1.1.1", "method": "icmp-paris"}')
ON CONFLICT DO NOTHING;

INSERT INTO agent_task (agent_config_id, task_id, type, enabled, generation, schedule_interval_seconds, schedule_jitter_percent, schedule_enabled, params)
VALUES ('fff05400-686d-46fe-b6d7-a660569f5228', 'ping-to-quad9', 'ping', true, 1, 20, 10, true, '{"target": "9.9.9.9", "count": 5, "size": 64}')
ON CONFLICT DO NOTHING;

INSERT INTO agent_task (agent_config_id, task_id, type, enabled, generation, schedule_interval_seconds, schedule_jitter_percent, schedule_enabled, params)
VALUES ('fff05400-686d-46fe-b6d7-a660569f5228', 'trace-to-quad9', 'trace', true, 1, 40, 10, true, '{"target": "9.9.9.9", "method": "icmp-paris"}')
ON CONFLICT DO NOTHING;
